...
var device = React.createClass({displayName: "device",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "col-xs-6 cols-sm-4 col-md-3"}, 
        React.createElement("div", {className: "thumbnail"}, 
          React.createElement("img", {src: "/assets/tv.jpg"}), 
          React.createElement("h3", null, this.props.title, 
            React.createElement("a", {href: "#", className: "pull-right btn btn-link", onClick: this.deleteDevice}, React.createElement("span", {className: "glyphicon glyphicon-remove"}))
          ), 
          React.createElement("button", {className: "btn btn-danger", onClick: this.play}, React.createElement("span", {className: "glyphicon glyphicon-play"}), " Play")
        )
      )
    );
  }
...
var deviceList = React.createClass({displayName: "deviceList",
  ...
  render: function() {
    var list = this.props.list.map(function(device){
      return React.createElement(Device, {key: device._id, id: device._id, title: device.title, 
    ...
    return (
      React.createElement("div", {className: "panel panel-default"}, 
        React.createElement("div", {className: "panel-heading"}, React.createElement("h4", null, "Paired Devices")), 
...
},{"./device":157,"react":156}],159:[function(require,module,exports){
/** @jsx React.DOM */
  ...
  render: function(){
    return (
      React.createElement("div", {className: "container"}, 
        React.createElement(Form, {onPairing: this.pairDevice}), 
        React.createElement(Devices, {list: this.state.deviceList, 
...
},{"./deviceList":158,"./pairingForm":160,"react":156}],160:[function(require,module,exports){
/** @jsx React.DOM */
...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function(){
    return (
      React.createElement("div", {className: "panel panel-default"}, 
        React.createElement("div", {className: "panel-body"}, 
          React.createElement("div", {className: "row"}, React.createElement("div", {className: "col-xs-12"}, React.createElement("h4", null, "Add new device"))), 
          React.createElement("div", {className: "row"}, 
            React.createElement("div", {className: "col-xs-12"}, 
              React.createElement("form", {className: "form-inline", ref: "pairingForm", onSubmit: this.onSubmit}, 
                React.createElement("div", {className: "form-group"}, 
                  React.createElement("input", {type: "text", ref: "code", className: "form-control", placeholder: "Pairing Code"})
                ), 
...
},{"./components/main":159,"react":156}]},{},[161])